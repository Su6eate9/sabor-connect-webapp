    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <>
          ...
          {/* Share Panel */}
          <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden animate-scale-in">
            <div className="p-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">Copiar Link</span>
                </button>
              </div>
            </div>
          </div>
